...
export interface BvmGovernorInterface extends utils.Interface {
  functions: {
    "BALLOT_TYPEHASH()": FunctionFragment;
    "CLOCK_MODE()": FunctionFragment;
    "COUNTING_MODE()": FunctionFragment;
    "EXTENDED_BALLOT_TYPEHASH()": FunctionFragment;
    "adminCancel(address[],uint256[],bytes[],bytes32)": FunctionFragment;
    ...
    "proposerCancel(address[],uint256[],bytes[],bytes32)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "proposerCancel",
    values: [string[], BigNumberish[], BytesLike[], BytesLike]
  ): string;
  encodeFunctionData(
...
export interface BvmGovernor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BvmGovernorInterface;
  ...
  callStatic: {
    ...
    initialize(shardToken: string, overrides?: CallOverrides): Promise<void>;
