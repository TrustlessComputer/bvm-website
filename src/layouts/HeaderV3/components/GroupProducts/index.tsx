      ...
      <div className={s.left}>
        ...
        <div className={s.group}>
          ...
          <ul className={`${s.group_inner} ${s.isFlex}`}>
            <li className={s.isDisabled}>
              <Link href={'/module-detail'} className={s.group_item_icon}>
                <Image width={48} height={48} sizes="100vw" quality="100" src="/bvm/bitcoinordinals.png"
                       alt="menu-icon-cel" />
                <div className={s.group_item_icon_text}>
            ...
            <li className={s.isDisabled}>
              <Link href={'/module-detail'} className={s.group_item_icon}>
                <Image width={48} height={48} sizes="100vw" quality="100" src="/bvm/bitcoinstamps.png"
                       alt="menu-icon-avail" />
                <div className={s.group_item_icon_text}>
