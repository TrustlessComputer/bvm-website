import { Button, Flex, Popover, PopoverContent, PopoverTrigger, Text } from '@chakra-ui/react';
...
const Connect = () => {
  const { requestAccount, isAuthen, buttonText, nakaAddress, loading, onLogout } = useNakaAuthen();
  ...
  const renderConnected = () => {
    return (
      <Popover trigger="hover">
        ...
        >
          <Flex alignItems="center" gap="24px" cursor="pointer" onClick={() => {
            onLogout();
          }}>
  ...
  return (
    isAuthen ? renderConnected() : renderConnect()
  )
}
