    ...
    >
      <BoxContent>
        ...
        <Text
          ...
          mr="auto"
        >
          Our mission is to make Bitcoin as generalized as possible — usable for
          far more than just a currency. We want DeFi, Gaming, AI, DAOs, and
          NFTs all on Bitcoin.
        </Text>
        <Box
        ...
        >
          ...
          />
          <Image
            src="public-sale/t-videos.jpeg"
            position="absolute"
            top="0"
            id={BANNER_ID}
            className={cs(styles.banner)}
            onClick={() => {
