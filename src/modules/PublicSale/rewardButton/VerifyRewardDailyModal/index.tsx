...
import { claimRewardDailyWithPost } from '@/services/public-sale';
...
const VerifyRewardDailyModal = ({
  ...
  const onSubmit = async (values: FormValues) => {
    try {
      setIsCreating(true);
      const result = await claimRewardDailyWithPost(
...
export default VerifyRewardDailyModal;
