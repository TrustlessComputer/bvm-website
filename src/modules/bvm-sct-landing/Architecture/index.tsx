  ...
  return (
    <div className={`${s.architectureWrapper}`}>
      <div className={'container'}>
        ...
        <Fade delay={1.2}>
          <p className={s.content}>BVM is a state machine similar to Ethereum-VM that utilizes the Bitcoin blockchain as a
          ...
          <p className={s.content}>There are 4 most important components needed to explain: the local mempool, Ethereum-like VM, TxWriter, and
            TxReader.</p>
        </Fade>
      </div>
    </div>
