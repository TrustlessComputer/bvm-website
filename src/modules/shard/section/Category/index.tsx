...
const cardGameFiData = [
  {
    ...
    bgColorImage: '#FAC5FF',
    actionTitle: `Treasury <strong>50,000,000 BVM $treasuryValue</strong>. <a href='/bvm' target='_self'>Learn more <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
