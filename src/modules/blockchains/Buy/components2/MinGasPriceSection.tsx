  ...
  return (
    <Section
      ...
      descriptionDetail={{
        ...
        content: (
          <p>
            Similar to the minimum gas price on other EVM-based blockchains, the
            gas price for transactions within your Bitcoin L2 must be set to a
            value higher than or equal to the one you choose.
          </p>
        ),
      }}
    >
