...
const AccountAbstractionDappPage = () => {
      ...
      <div className={s.container}>
        ...
        >
          <Flex flexDir={'row'} mt={'20px'} gap={'10px'} w={'100%'}>
            <Flex id="left-droppable" className={s.showroomLegosContainer}>
            ...
            >
              <AppViewer
                ...
                onExportClick={() => {
                  console.log('onExportClick TO DO');
                }}
                onShareClick={() => {
                  console.log('onShareClick TO DO');
                }}
              />
            </Flex>
            <DragMask />
...
export default enhance(AccountAbstractionDappPage);
