...
const ActivityKey = ['game', 'naka', 'modular', 'social', 'ai'];
    ...
    <li>
      <div style='display: flex; flex-direction: row; align-items: end'>
        ...
        <a href='${p.link}' target='_blank'
           style='display: flex; flex-direction: row; gap: 8px; align-items: center; font-size: 14px; color: #FFA888; font-weight: 400; margin-left: 8px;'>
          ${p.value}
          ${p?.isSpecial ? (
...
export const ReportRow = (p: { key: string, value: string, prefix?: string, maxDigit?: number, diffNumb?: number }) => {
  return (
    <Flex flexDir='row' alignItems='end' color='white'>
      {p.prefix && (
      ...
      />*/}
      <Text fontSize='12px' lineHeight='140%' color='white' fontWeight='500'>
