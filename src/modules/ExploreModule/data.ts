...
export const DAPPS_DATA: Omit<TDappCardProps, 'idx'>[] = [
  {
    ...
    tags: ['EternalAI Chain', 'Mobile', 'L2', 'Optimistic Rollup'],
    link: {
  ...
  },
  {
    ...
    tags: ['Bitcoin Wars Chain', 'Mobile', 'L3', 'ZK Rollup'],
  ...
  },
  {
    ...
    tags: ['RuneChain', 'Web', 'L2', 'Optimistic Rollup'],
    link: {
  ...
  },
  {
    ...
    tags: ['NakaChain', 'Mobile', 'L2', 'Optimistic Rollup'],
    link: {
  ...
  },
  {
    ...
    tags: ['RuneChain', 'Mobile', 'L2', 'Optimistic Rollup'],
    link: {
