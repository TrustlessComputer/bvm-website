...
import CPaymentSWPAPI from '../../services/payment.swp';
import s from './styles.module.scss';

const LaunchpadClaimSwamps = () => {
      ...
      <Center className={cx(s.wrapper)}>
        <Center className={cx(s.container, s.loadingContainer)}>
          <Text className={s.title}>
            Claim your <span>$GSWP</span>
          </Text>
          <Text className={s.desc}>
            Thank you for participating in the $GSWP IDO.
            <br />
            Exclusive 0.5% of the $GSWP supply will be airdropped for $GSWP IDO
            participants
          </Text>
          <Text className={s.desc}>
            Your total airdropped $GSWP is {formatCurrency(amountAllocation)}{' '}
            $GSWP.
            <Tooltip
              minW="220px"
              bg="#000000"
              label={
                <Flex direction="column" color="#ffffff" padding={'4px'}>
                  Notes:
                  <p>
                    - You will receive the first airdropped $GSWP on{' '}
                    {dayjs('03/18/2024').add(90, 'day').format('MM/DD/YYYY')}.
                  </p>
                  <p>- Your airdropped $GSWP will be locked for 1 years</p>
          ...
          <FAQs
            data={[
              ...
              },
              {
                ...
                a: `<p>0.5% of the $GSWP supply will be airdropped to all wallets that purchased tickets for the $GSWP IDO</p>`,
              },
            ]}
          />
        </Flex>
...
export default LaunchpadClaimSwamps;
