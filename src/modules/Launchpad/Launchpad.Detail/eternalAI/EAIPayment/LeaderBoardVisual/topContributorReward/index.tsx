    ...
    <Box className={s.container}>
      ...
      >
        <Flex direction={'column'}>
          ...
          {/*  Increase your contribution by at least $12(0.2BVM) to receive a*/}
          {/*  Solaris.*/}
          {/*</Text>*/}
          <Flex gap={4}>
            <Flex
            ...
            >
              <Text>Button</Text>
              <Center w={'20px'} height={'20px'} bgColor={'#FFFFFF'}>
                <svg
                  width="30"
                  height="30"
                  viewBox="0 0 30 30"
