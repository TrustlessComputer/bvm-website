...
import useFormatAllowSAVM from './useFormatAllowSAVM';

const allowSAVMMessage = () => {
  const { loaded, status, isProcessing, amount } = useFormatAllowSAVM();
...
export default allowSAVMMessage;
