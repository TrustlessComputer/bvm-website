...
export default function Intro() {
  ...
  return <div ref={refContent} className={s.intro}>
    <div className={s.intro_inner}>
      ...
      <p className={s.intro_inner_content}>Connect these two building blocks to <br/> enter the <span>future of Bitcoin</span>.</p>
      <div className={s.drag} onMouseMove={onMouse} onTouchMove={onMouse}>
        ...
        <div ref={refWrap} className={s.drag_inner} onMouseLeave={onMouseUp}>
          <button ref={refBtn} onMouseDown={onMouseDown} onTouchStart={onMouseDown} onTouchEnd={onMouseUp} onMouseUp={onMouseUp}><img
