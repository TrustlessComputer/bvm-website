      ...
      {!played && (
        <div className={s.intro_inner}>
          <div className={s.intro_supper_content}>
            <h1 className={s.intro_supper_content_bitcoin}>
          ...
          <div className={s.intro_inner_bottom}>
            ...
            <div className={s.drag} onMouseMove={onMouse} onTouchMove={onMouse}>
              ...
              <button className={s.mood}>
                <img
                  className={s.mood_substract}
                  src="/landing/subtract.svg?v=2"
                  alt="substract"
                />
                <img
                  className={s.mood_door}
                  src="/landing/door.png"
                  alt="door"
                />
                <div ref={refFlare} className={s.flare}></div>
              </button>
            </div>
          </div>
        </div>
