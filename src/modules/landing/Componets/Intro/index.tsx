...
export default function Intro() {
  ...
  const onMouseUp = () => {
    ...
    if (refActions.current.current > rectWrap.width / 2) {
      ...
      gsap.to(gradientRef.current, { '--bg': '0%', ease: 'power3.out', duration: .6 });
    }
  };
  ...
  const onMouseDown = () => {
    ...
    gsap.to(gradientRef.current, { '--bg': '100%', ease: 'power3.out', duration: .6 });
  };
  ...
  return <div className={s.intro}>
    <div className={s.intro_inner}>
      ...
      <div className={s.drag} onMouseMove={onMouse}>
        <div ref={gradientRef} className={s.drag_gradient}></div>
        <div className={s.drag_line}>
          <svg xmlns='http://www.w3.org/2000/svg' width='162' height='2' viewBox='0 0 162 2' fill='white'>
            <path
