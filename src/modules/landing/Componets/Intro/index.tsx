      ...
      !played && <div className={s.intro_inner}>
        <div className={s.intro_inner_thumbnail} ref={refThumb}>
          <div className={s.grid}>
            <svg xmlns='http://www.w3.org/2000/svg' width='567' height='194' viewBox='0 0 567 194' fill='none'>
              <path opacity='0.7'
              ...
              <defs>
                <radialGradient id='paint0_radial_28277_8486' cx='0' cy='0' r='1' gradientUnits='userSpaceOnUse'
                                gradientTransform='translate(283.115 90.2439) rotate(3.8316) scale(189.71 83.2907)'>
                  <stop stop-color='#EE223C' />
                  <stop offset='0.27' stop-color='#F26922' stop-opacity='0.63' />
                  <stop offset='0.54' stop-color='#FA9F1A' stop-opacity='0.76' />
