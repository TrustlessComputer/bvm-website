...
import { useOrdinalsStore } from './useOrdinalsStore';
...
const OrdinalsNode = ({ data, id }: NodeProps<DappNodeProps>) => {
  const { dapp } = data;
  ...
  const OrdinalsStore = useOrdinalsStore();
  console.log('OrdinalsStore --- ', OrdinalsStore);
