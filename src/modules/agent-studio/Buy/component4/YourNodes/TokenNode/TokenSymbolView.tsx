...
export const TokenSymbolView = (props: Props) => {
  const { tokenSymbolStr, setTokenSymbolStr, stepper } = useTokenModuleStore();
  ...
  return (
    ...
    >
      ...
      <Tooltip
        label="Token symbol information ....."
        fontSize="12px"
        color={'#000'}
        bgColor={'#fff'}
      >
      ...
      <AppInput
        ...
        value={tokenSymbolStr}
        placeholder="e.g YTKN"
        minW={'300px'}
        onChange={(e: any) => {
          let inputValue = e.target.value;
          setTokenSymbolStr(inputValue);
        }}
      ></AppInput>
    </Flex>
  );
