...
export const FAQ_POC = [
  ...
  },
  {
    ...
    a: `<p>To register, simply click on the "Let's Practice" button above on top of this page, then sign in using your email. That's it, you're all set to join the competition.</p><br/><p>The Proof of Code competition and practice session are completely free to participate.</p><br/><p>Don't forget to practice before the competition.</p>`,
  },
  {
