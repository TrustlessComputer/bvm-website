// import { IagentBuyReq } from '@/stores/states/l2services/types';
// import { IagentBuyEstimateRespone } from '@/services/api/l2services/types';
...
export const getPictureSharing = async (
  ...
  //     `/agent/upload/get-file-url?getKey=${key}`,
  //   );
  //
